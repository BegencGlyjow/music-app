      ...
      <main className="w-full mx-auto col-span-12 lg:col-span-6">
        ...
        </aside>
        {
          allfiles.map((file, id) => {
            return (
              <aside key={id} className='flex-center justify-between text-3xl mt-3 mb-4 font-sans font-extrabold text-slate-50 border-r border-l border-lime-600 p-2 rounded-full bg-black/70'>

...
const Body = () => {
  return (
    <section className='ml-28 bg-black py-4 space-y-8 md:max-w-6xl flex-grow md:mr-2.5'>
        <SearchBar/>
        {/* <div className="grid overflow-y-scroll scrollbar-hide h-96 py-4 grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-4 gap-y-8 p-4">

        </div>
        <main className="flex gap-x-8 absolute min-w-full md:relative ml-6">
        <main className="hidden xl:inline max-w-[270px]">

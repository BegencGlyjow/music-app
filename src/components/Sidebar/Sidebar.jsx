...
const Sidebar = () => {
  ...
  return (
    ...
    <section className={`fixed top-0 ${isOpen ? '-left-28':'left-0'}  duration-500 rounded-r-full  flex flex-col p-4 bg-gradient-to-t  from-black to-lime-900/10 items-center w-[90px] h-screen space-y-8 border-r border-lime-500/50`}>  

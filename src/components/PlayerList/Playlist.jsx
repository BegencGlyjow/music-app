...
const Playlist = () => {
  return (
    <section className='absolute text-slate-200 md:left-28 left-3 top-[750px] right-3 bg-black  bg-opacity-30 p-4 rounded-xl flex flex-row'>
    ...
    <div className='flex flex-row font-dancing-bold text-lg mr-3 hover: hover:border-b duration-500 border-lime-600 hover:text-lime-600 cursor-pointer rounded-lg p-2 '>

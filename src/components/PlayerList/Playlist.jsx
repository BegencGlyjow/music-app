...
import { HiChartBar, HiMicrophone, HiMusicNote} from 'react-icons/hi'

const Playlist = () => {
  return (
    <section 
    className=' text-slate-50 bg-gradient-to-l from-lime-600/5 to-black/75  bg-opacity-30 mt-3 mb-5 rounded-xl flex flex-row justify-between md:justify-center'>
